...
完成するのに3日もかかったけど、2の拡大体と任意の次数を持つ多項式の既約性判定ができるようになった。
...
何かがおかしいんだと思うけど、多分 $N^2$ 以上の計算をしているんだと思う。
掛け算関数をよく使っているので結局掛け算を高速化しないと効果が出ないのかも。
逆関数を計算する方法が漸化式で表現できるのは驚きであった。
